...
各课程的 README.md 应遵循统一的结构，以便于阅读和维护。具体规范如下：

* **一级标题**：当前课程名称
* **二级标题**：以 **课号 课程名称** 形式列出（考虑到课号可能变动，如曾经的汇编，12 级之前为 3 学分必修课）
  * **三级标题**：第一部分 总述
    * **四级标题**：教材
    * **四级标题**：作业
    * **四级标题**：课堂
...
可参考仓库根目录下的 [README_TEMPLATE.md](./README_TEMPLATE.md) 模板文件。

**注意**：

* 尽量 **简略** 列出有关课程的 **所有** 内容；
* 对任课教师的评价应客观公正，避免人身攻击。
