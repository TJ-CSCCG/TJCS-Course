...
xst -ifn xst.scr
move PxlClkGen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PxlClkGen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PxlClkGen_exdes.ucf PxlClkGen_exdes

echo 'Running map'
map -timing -pr b PxlClkGen_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PxlClkGen_exdes -w routed.ncd routed.vhd
cd ..
